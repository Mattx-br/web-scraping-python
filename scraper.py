...
headers = {
    # para saber o user agent do seu pc, escreva no google: my user agent e copie o resultado
...
episodes = soup.find_all('tr', class_='tr-ep-list tr-quality-web-dl')  # ta usando underline do lado do class pq class já é uma palavra reservada do python, ai o beautiful soup usa o underline para diferenciar
# episode = episodes[-1]
#
#
...
# ep_link = episode.find('a', href=True)
# episode_info = [ep_name, ep_resolution, ep_size, ep_link['href']]
